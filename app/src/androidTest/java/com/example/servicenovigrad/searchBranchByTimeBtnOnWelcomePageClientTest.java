...
public class searchBranchByTimeBtnOnWelcomePageClientTest {
    ...
    public void launchOfServiceActivityOnButtonClick() {
        assertNotNull(mActivity.findViewById(R.id.searchByTime_button));
        onView(withId(R.id.searchByTime_button)).perform(click());
    }
