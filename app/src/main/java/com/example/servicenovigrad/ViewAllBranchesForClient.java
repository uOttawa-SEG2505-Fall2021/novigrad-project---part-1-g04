...
public class ViewAllBranchesForClient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_all_branches_for_client);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //creating adapter
                ListAdapter adapter = new BranchListAdapter(ViewAllBranchesForClient.this, branchList);
        ...
        branchesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ViewAllBranchesForClient.this, ViewServicesFromBranchForClient.class);
